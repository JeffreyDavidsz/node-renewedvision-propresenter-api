...
- [constructor](ProPresenter.md#constructor)

### Properties

- [ip](ProPresenter.md#ip)
- [port](ProPresenter.md#port)

### Methods

- [announcementActiveFocus](ProPresenter.md#announcementactivefocus)
- [announcementActiveIndexTrigger](ProPresenter.md#announcementactiveindextrigger)
- [announcementActiveTimelineOperation](ProPresenter.md#announcementactivetimelineoperation)
- [announcementGetActive](ProPresenter.md#announcementgetactive)
- [announcementGetActiveTimelineOperation](ProPresenter.md#announcementgetactivetimelineoperation)
- [announcementGetSlideIndex](ProPresenter.md#announcementgetslideindex)
- [announcementNextTrigger](ProPresenter.md#announcementnexttrigger)
- [announcementPreviousTrigger](ProPresenter.md#announcementprevioustrigger)
- [announcementTrigger](ProPresenter.md#announcementtrigger)
- [audioGetPlaylists](ProPresenter.md#audiogetplaylists)
- [audioGetPlaylistsActive](ProPresenter.md#audiogetplaylistsactive)
- [audioGetPlaylistsByPlaylistId](ProPresenter.md#audiogetplaylistsbyplaylistid)
- [audioGetPlaylistsByPlaylistIdUpdates](ProPresenter.md#audiogetplaylistsbyplaylistidupdates)
- [audioGetPlaylistsFocused](ProPresenter.md#audiogetplaylistsfocused)
- [audioPlaylistsActiveFocus](ProPresenter.md#audioplaylistsactivefocus)
- [audioPlaylistsActiveIdTrigger](ProPresenter.md#audioplaylistsactiveidtrigger)
- [audioPlaylistsActiveNextTrigger](ProPresenter.md#audioplaylistsactivenexttrigger)
- [audioPlaylistsActiveTrigger](ProPresenter.md#audioplaylistsactivetrigger)
- [audioPlaylistsActivedPreviousTrigger](ProPresenter.md#audioplaylistsactivedprevioustrigger)
- [audioPlaylistsByPlaylistIdFocus](ProPresenter.md#audioplaylistsbyplaylistidfocus)
- [audioPlaylistsByPlaylistIdNextTrigger](ProPresenter.md#audioplaylistsbyplaylistidnexttrigger)
- [audioPlaylistsByPlaylistIdPreviousTrigger](ProPresenter.md#audioplaylistsbyplaylistidprevioustrigger)
- [audioPlaylistsByPlaylistIdTrigger](ProPresenter.md#audioplaylistsbyplaylistidtrigger)
- [audioPlaylistsFocusedIdTrigger](ProPresenter.md#audioplaylistsfocusedidtrigger)
- [audioPlaylistsFocusedNextTrigger](ProPresenter.md#audioplaylistsfocusednexttrigger)
- [audioPlaylistsFocusedPreviousTrigger](ProPresenter.md#audioplaylistsfocusedprevioustrigger)
- [audioPlaylistsFocusedTrigger](ProPresenter.md#audioplaylistsfocusedtrigger)
- [audioPlaylistsNextFocus](ProPresenter.md#audioplaylistsnextfocus)
- [audioPlaylistsPreviousFocus](ProPresenter.md#audioplaylistspreviousfocus)
- [getDataFromProPresenter](ProPresenter.md#getdatafrompropresenter)
- [version](ProPresenter.md#version)
